...
let food = 'chocolate covered strawberries';
...
let friendsPets = 5;
console.log(`Ro's Pets:`, friendsPets);
...
if(pets > friendsPets){
    ...
    mostPets = pets;
    console.log('You and Ro have the same number of pets');
}    
...
switch(luckyNumber){
    ...
    case 2:
        ...
        break;
    case 3:
        console.log('Third is the one with the polka dress');
        break;
    default:
